        ...
        <div className="footer-column footer-contact-column">
          ...
          <div className="footer-contact-details">
            ...
            >
              ...
              <span>0707124666</span>
            </a>

            <a
              href="https://www.tiktok.com/@bloomlife.official"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-contact-item tiktok"
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
              ...
              <span>bloomlife.official</span>
            </a>

            <a
              href="https://www.facebook.com/share/1CxfHS8o2P/"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-contact-item facebook"
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
